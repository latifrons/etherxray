...
func init() {
	...
	rootCmd.PersistentFlags().Bool("multifile-by-level", false, "MaxOutput separate log files according to their level")
	rootCmd.PersistentFlags().Bool("multifile-by-module", false, "MaxOutput separate log files according to their module")
